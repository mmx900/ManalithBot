...
public class DubeolSymbol {
	...
	{
		nul(99), r(0), R(1), s(2), e(3), E(4), f(5), a(6), q(7), Q(8), t(9),
	...
	{
		nul(99), k(0), o(1), i(2), O(3), j(4), p(5), u(6), P(7), h(8), hk(9), ho(10), hl(11),
		y(12), n(13), nj(14), np(15), nl(16), b(17), m(18), ml(19), l(20);
	...
	{
		nul(0), r(1), R(2), rt(3), s(4), sw(5), sg(6), e(7), f(8), fr(9), fa(10), fq(11), ft(12), 
		fx(13), fv(14), fg(15), a(16), q(17), qt(18), t(19), T(20), d(21), w(22), c(23), z(24), 
		x(25), v(26), g(27);
	...
	public static enum DubeolSingleLetter
	{
		...
		// Single Consonant : 30
		r(1), R(2), rt(3), s(4), sw(5), sg(6), e(7), E(8), f(9), fr(10), fa(11), fq(12), 
		ft(13), fx(14), fv(15), fg(16),	a(17), q(18), Q(19), qt(20), t(21), T(22), d(23),
		w(24), W(25), c(26), z(27), x(28), v(29), g(30),
		
		// Single Vowel : 21
		k(31), o(32), i(33), O(34), j(35), p(36), u(37), P(38), h(39), hk(40), ho(41),
		hl(42), y(43), n(44), nj(45), np(46), nl(47), b(48), m(49), ml(50), l(51);
